...
class Run(object):
    ...
    def summary(self):
        s = {"run" : self.nrun,
             "mean_tow_speed" : self.mean_u_enc,
             "std_tow_speed" : self.std_u_enc,
             "t1" : self.t1,
             "t1_wake" : self.t1_wake,
             "t2" : self.t2,
             "t2_wake" : self.t2_wake,
             "n_revs" : self.n_revs,
             "n_blade_pass" : self.n_blade_pass,
             "y_R" : self.y_R,
             "z_H" : self.z_H,
             "mean_tsr" : self.mean_tsr,
             "mean_cp" : self.mean_cp,
             "mean_cd" : self.mean_cd,
             "std_tsr" : self.std_tsr,
             "std_cp" : self.std_cp,
             "std_cd" : self.std_cd,
             "std_tsr_per_rev" : self.std_tsr_per_rev,
             "std_cp_per_rev" : self.std_cp_per_rev,
             "std_cd_per_rev" : self.std_cd_per_rev,
             "exp_unc_tsr" : self.exp_unc_tsr,
             "exp_unc_cp" : self.exp_unc_cp,
             "exp_unc_cd" : self.exp_unc_cd,
             "dof_tsr" : self.dof_tsr,
             "dof_cp" : self.dof_cp,
             "dof_cd" : self.dof_cd,
             "mean_u" : self.mean_u,
             "mean_v" : self.mean_v,
             "mean_w" : self.mean_w,
             "mean_upvp" : self.mean_upvp,
             "mean_upwp" : self.mean_upwp,
             "mean_vpwp" : self.mean_vpwp,
             "std_u" : self.std_u,
             "std_v" : self.std_v,
             "std_w" : self.std_w,
             "k" : self.k}
